...
naughty.config.defaults.icon_size = 64 -- для больших нотификаций
...
beautiful.init("/home/ilya_egorov/.config/awesome/themes/redhalo/theme.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, }, "e", function () awful.util.spawn("google-chrome") end),
    awful.key({ modkey, }, "u", function () awful.util.spawn("thunar") end)
)
...
awful.rules.rules = {
    ...
    { rule = { class = "jetbrains-phpstorm" },  properties = { tag = tags[2][2], floating = true, maximized_vertical = true, maximized_horizontal = true } },
    { rule = { class = "Skype" }, properties = { tag = tags[1][2] } },
    { rule = { class = "ConversationsWindow" }, properties = { tag = tags[1][2], floating = true } },
    { rule = { class = "x-terminal-emulator" }, properties = { tag = tags[2][1], floating = false } }, 
    { rule = { class = "robomongo" }, properties = { tag = tags[1][4], floating = true, maximized_vertical = true, maximized_horizontal = true } },
...
awful.util.spawn_with_shell("~/bin/desktop.sh")
